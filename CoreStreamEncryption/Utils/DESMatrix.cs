namespace CoreStreamEncryption.Utils
{
    internal static partial class DESUtils
    {
        ...
        private readonly static int[] FP =
        {
        ...
        private readonly static int[] EP = new int[48]
        {
            32, 1, 2, 3, 4, 5,
            4, 5, 6, 7, 8, 9,
            8, 9, 10, 11, 12, 13,
        ...
        private readonly static byte[] P = new byte[32]
        {
            16, 7 , 20, 21, 29, 12, 28, 17, 1 , 15, 23, 26, 5 , 18, 31, 10,
            2 , 8 , 24, 14, 32, 27, 3 , 9 , 19, 13, 30, 6 , 22, 11, 4 , 25,
        };
        private readonly static byte[] K1P = new byte[28]
        {
            57, 49, 41, 33, 25, 17, 9 , 1 , 58, 50, 42, 34, 26, 18,
            10, 2 , 59, 51, 43, 35, 27, 19, 11, 3 , 60, 52, 44, 36,
        };
        private readonly static byte[] K2P = new byte[28]
        {
            63, 55, 47, 39, 31, 23, 15, 7 , 62, 54, 46, 38, 30, 22,
            14, 6 , 61, 53, 45, 37, 29, 21, 13, 5 , 28, 20, 12, 4 ,
        };
        private readonly static byte[] CP = new byte[48]
        {
