...
namespace CoreStreamEncryption.Abstract
{
    public abstract class LoggerIteration
    {
        ...
        public abstract void LoggerRoundIteration(IStreamTransformation currentStreamTransformation, int indexRount, BigInteger left, BigInteger right, BigInteger key);
